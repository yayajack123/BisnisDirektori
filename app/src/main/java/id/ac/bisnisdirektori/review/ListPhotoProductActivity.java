...
public class ListPhotoProductActivity extends AppCompatActivity {
    ...
    int success;
    private static final String TAG = ListPhotoProductActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_photo_product);
...
//        id = getIntent().getStringExtra (TAG_ID);
        ...
        ListEvent = findViewById (R.id.ListPhotoProduct);
        txtAlert = findViewById (R.id.txtAlert);
        cla = new AdapterListPhotoProduct (ListPhotoProductActivity.this);
        ListAPI = ADMIN_PANEL_URL + "/get_list_photo_product.php?id_data="+idData;
...
//        edtIdData.setText(idData);
        ...
        ListEvent.setOnItemClickListener (new AdapterView.OnItemClickListener () {
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                Intent iDetail = new Intent (ListPhotoProductActivity.this, ImageReviewActivity.class);
