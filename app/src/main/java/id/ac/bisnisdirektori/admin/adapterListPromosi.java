...
public class adapterListPromosi extends BaseAdapter {
    public static String ADMIN_PANEL_URL = "https://www.pantaucovid19.net/";
    private Activity activity;
    public adapterListPromosi(Activity act) {
        this.activity = act;
    }


    public int getCount() {
        return ListManagePromosiActivity.id_data.size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.row_list_manage_promosi, null);
        ...
        holder.txtAlamat.setText(ListManagePromosiActivity.alamat.get(position));
        holder.txtOtherinfo.setText(ListManagePromosiActivity.otherinfo.get(position));
        holder.txtIdAdmin.setText(ListManagePromosiActivity.id_admin.get(position));
        Picasso.with(activity).load(ADMIN_PANEL_URL+"/"+ListManagePromosiActivity.foto.get(position)).placeholder(R.drawable.imgthumb).into(holder.imgThumb);
        return convertView;
